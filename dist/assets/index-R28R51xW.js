const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LoginPage-DbFCxaI7.js","assets/react-gNaiavg9.js","assets/firebase-BkMFZbKL.js","assets/AdminPage-DCILBE04.js","assets/scheduleService-BdPhcS23.js","assets/standingsService-mvg5NuvE.js","assets/SchedulePage-B2ypitVh.js","assets/StandingsPage-CLTxO-W0.js"])))=>i.map(i=>d[i]);
import{r as Os,a as Ls,g as Us,b,N as Ds,R as Ms,c as w,L as be,u as Fs,O as qs,d as Vs,B as zs}from"./react-gNaiavg9.js";import{L as Ws,g as Vt,i as Hs,a as Bs,_ as Ge,C as $e,r as ye,b as Gs,S as Z,E as Qe,c as T,d as C,e as v,f as $s,h as zt,F as Ae,j as Ks,q as ce,k as Ce,l as Wt,m as Ze,n as Js,o as Ke,p as Ht,u as Bt,s as Ys,t as Xs,v as re,w as ne,x as Qs,y as Zs,z as er,A as tr,B as sr,D as Gt,G as $t,H as Kt,I as Jt,J as rr,K as nr,M as ir}from"./firebase-BkMFZbKL.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(n){if(n.ep)return;n.ep=!0;const a=t(n);fetch(n.href,a)}})();var qe={exports:{}},se={};/**
 * @license React
 ...
 */const Ie=new Ws("@firebase/auth");function mr(s,...e){Ie.logLevel<=zt.WARN&&Ie.warn(`Auth (${Z}): ${s}`,...e)}function xe(s,...e){Ie.logLevel<=zt.ERROR&&Ie.error(`Auth (${Z}): ${s}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class le{constructor(e,t){this.shortDelay=e,this.longDelay=t,U(t>e,"Short delay should be less than long delay!"),this.isMobile=Hs()||Bs()}get(){return gr()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tr(s,e){return W(s,"POST","/v1/accounts:delete",e)}async function Ee(s,e){return W(s,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ur(s,e={}){return W(s,"GET","/v2/passwordPolicy",G(s,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kr(s,e){const t=Ze(s,"auth");if(t.isInitialized()){const n=t.getImmediate(),a=t.getOptions();if(Ke(a,e??{}))return n;R(n,"already-initialized")}return t.initialize({options:e})}function Jr(s,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(L);e!=null&&e.errorMap&&s._updateErrorMap(e.errorMap),s._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Yr(s,e,t){const r=ee(s);p(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const n=!1,a=fs(e),{host:o,port:l}=Xr(e),c=l===null?"":`:${l}`,d={url:`${a}//${o}${c}/`},u=Object.freeze({host:o,port:l,protocol:a.replace(":",""),options:Object.freeze({disableWarnings:n})});if(!r._canInitEmulator){p(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),p(Ke(d,r.config.emulator)&&Ke(u,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=u,r.settings.appVerificationDisabledForTesting=!0,Ce(o)?(Ht(`${a}//${o}${c}`),Bt("Auth",!0)):Qr()}function fs(s){const e=s.indexOf(":");return e<0?"":s.substr(0,e+1)}function Xr(s){const e=fs(s),t=/(\/\/)?([^?#/]+)/.exec(s.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",n=/^(\[[^\]]+\])(:|$)/.exec(r);if(n){const a=n[1];return{host:a,port:It(r.substr(a.length+1))}}else{const[a,o]=r.split(":");return{host:a,port:It(o)}}}function It(s){if(!s)return null;const e=Number(s);return isNaN(e)?null:e}function Qr(){function s(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",s):s())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nt{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return O("not implemented")}_getIdTokenResponse(e){return O("not implemented")}_linkToIdToken(e,t){return O("not implemented")}_getReauthenticationResolver(e){return O("not implemented")}}async function Zr(s,e){return W(s,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gn(s,e={}){return W(s,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ze="webStorageSupport";class xi{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ys,this._completeRedirectFn=zn,this._overrideRedirectResult=Fn}async _openPopup(e,t,r,n){var o;U((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const a=await St(e,t,r,Je(),n);return hi(e,a,at())}async _openRedirect(e,t,r,n){await this._originValidation(e);const a=await St(e,t,r,Je(),n);return wn(a),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:n,promise:a}=this.eventManagers[t];return n?Promise.resolve(n):(U(a,"If manager is not set, promise should be"),a)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await ai(e),r=new Hn(e);return t.register("authEvent",n=>(p(n==null?void 0:n.authEvent,e,"invalid-auth-event"),{status:r.onEvent(n.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ze,{type:ze},n=>{var o;const a=(o=n==null?void 0:n[0])==null?void 0:o[ze];a!==void 0&&t(!!a),R(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Jn(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return us()||is()||rt()}}const _i=xi;var At="@firebase/auth",Ct="1.12.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
