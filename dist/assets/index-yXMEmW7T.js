 ...
 */const Ie=new Ws("@firebase/auth");function mr(s,...e){Ie.logLevel<=Vt.WARN&&Ie.warn(`Auth (${Z}): ${s}`,...e)}function xe(s,...e){Ie.logLevel<=Vt.ERROR&&Ie.error(`Auth (${Z}): ${s}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ie(s){if(s)try{const e=new Date(Number(s));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Nr(s,e=!1){const t=C(s),r=await t.getIdToken(e),n=st(r);p(n&&n.exp&&n.auth_time&&n.iat,t.auth,"internal-error");const a=typeof n.firebase=="object"?n.firebase:void 0,o=a==null?void 0:a.sign_in_provider;return{claims:n,token:r,authTime:ie(ze(n.auth_time)),issuedAtTime:ie(ze(n.iat)),expirationTime:ie(ze(n.exp)),signInProvider:o||null,signInSecondFactor:(a==null?void 0:a.sign_in_second_factor)||null}}function ze(s){return Number(s)*1e3}function st(s){const[e,t,r]=s.split(".");if(e===void 0||t===void 0||r===void 0)return xe("JWT malformed, contained fewer than 3 sections"),null;try{const n=Ks(t);return n?JSON.parse(n):(xe("Failed to decode base64 JWT payload"),null)}catch(n){return xe("Caught error parsing JWT payload as JSON",n==null?void 0:n.toString()),null}}function gt(s){const e=st(s);return p(e,"internal-error"),p(typeof e.exp<"u","internal-error"),p(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cn(s,e,t=!1){const{auth:r}=s;if(T(r.app))return Promise.reject(V(r));const n="reauthenticate";try{const a=await ae(s,bs(r,n,e,s),t);p(a.idToken,r,"internal-error");const o=st(a.idToken);p(o,r,"internal-error");const{sub:l}=o;return p(s.uid===l,r,"user-mismatch"),Q._forOperation(s,n,a)}catch(a){throw(a==null?void 0:a.code)==="auth/user-not-found"&&R(r,"user-mismatch"),a}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xs(s,e,t=!1){if(T(s.app))return Promise.reject(V(s));const r="signIn",n=await bs(s,r,e),a=await Q._fromIdTokenResponse(s,r,n);return t||await s._updateCurrentUser(a.user),a}async function ln(s,e){return xs(ee(s),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve="webStorageSupport";class xi{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ys,this._completeRedirectFn=Vn,this._overrideRedirectResult=Fn}async _openPopup(e,t,r,n){var o;U((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const a=await St(e,t,r,Je(),n);return hi(e,a,at())}async _openRedirect(e,t,r,n){await this._originValidation(e);const a=await St(e,t,r,Je(),n);return wn(a),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:n,promise:a}=this.eventManagers[t];return n?Promise.resolve(n):(U(a,"If manager is not set, promise should be"),a)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await ai(e),r=new Hn(e);return t.register("authEvent",n=>(p(n==null?void 0:n.authEvent,e,"invalid-auth-event"),{status:r.onEvent(n.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Ve,{type:Ve},n=>{var o;const a=(o=n==null?void 0:n[0])==null?void 0:o[Ve];a!==void 0&&t(!!a),R(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Jn(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return us()||is()||rt()}}const _i=xi;var At="@firebase/auth",Ct="1.12.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
